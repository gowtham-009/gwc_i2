            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-70">
                        <!-- Title -->
                        <h2 class="s-50 w-700">3 Reason Why Becoming A POSP</h2>
                        <!-- Text -->
                ...
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-1 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Experience Choice with Convenience</h6>
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-2 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Experience Dedicated <br> Support</h6>
                    ...
                    <div class="col">
                        <div class="fbox-2 fb-3 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">Experience Tech That's innovative Yet Simple</h6>
